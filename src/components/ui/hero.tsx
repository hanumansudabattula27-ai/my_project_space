...
//           isDark
//             ? "bg-[radial-gradient(circle_at_50%_50%,rgba(255,255,255,0.02)_1px,transparent_1px)]"
//             : "bg-[radial-gradient(circle_at_50%_50%,rgba(59,130,246,0.05)_1px,transparent_1px)]"
//         } bg-[length:24px_24px]`}
//       />
...
//           isDark ? "border border-white/20" : "border border-blue-300/30"
//         }`}
//       />
//       <motion.div
//         initial={{ opacity: 0, scale: 0.8 }}
...
//           </span>
//           <span
//             className={`block leading-none min-h-[1.2em] flex items-center justify-center ${
...
//         transition={{ duration: 2, ease: "easeOut" }}
//         className={`absolute top-20 left-1/4 w-32 h-32 border rounded-full ${
//           isDark ? 'border-slate-700' : 'border-teal-400/40'
//         }`}
//       />
//       <motion.div
//         initial={{ opacity: 0, scale: 0.8 }}
...
//         transition={{ duration: 2, delay: 0.5, ease: "easeOut" }}
//         className={`absolute bottom-20 right-1/4 w-24 h-24 rounded-lg rotate-12 ${
//           isDark ? 'bg-slate-800/50' : 'bg-cyan-400/10'
//         }`}
//       />
...
//           </span>
//           <span className={`block leading-none min-h-[1.2em] flex items-center justify-center ${
//             isDark ? 'text-blue-400' : 'text-teal-600'
//           }`}>
//             <AnimatePresence mode="wait">
//               <motion.span
//                 key={words[currentWordIndex]}
  ...
  return (
    <section className="relative mx-auto max-w-7xl px-6 pt-35 pb-20 text-center overflow-hidden">
      ...
      <motion.div
        ...
        transition={{ duration: 2, ease: "easeOut" }}
        className={`absolute top-20 left-1/4 w-32 h-32 border rounded-full ${
          isDark ? 'border-indigo-700/40' : 'border-teal-400/40'
        }`}
      />
      <motion.div
        initial={{ opacity: 0, scale: 0.8 }}
        ...
        transition={{ duration: 2, delay: 0.5, ease: "easeOut" }}
        className={`absolute bottom-20 right-1/4 w-24 h-24 rounded-lg rotate-12 ${
          isDark ? 'bg-indigo-800/30' : 'bg-cyan-400/10'
        }`}
      />
