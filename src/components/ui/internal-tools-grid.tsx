              ...
              >
                <a href={tool.href} className="block w-full h-full">
                  <div className={`rounded-2xl p-6 tool-card h-full flex flex-col transition-all ${
                    ...
                    {/* <button className={`w-full bg-gradient-to-r text-white py-3 rounded-xl font-medium transition-all duration-300 transform hover:scale-105 mt-auto ${
                      isDark
                    ...
                    {/* <button className="w-full bg-gradient-to-r from-[#6366f1] to-[#10b981] hover:from-[#4f46e5] hover:to-[#059669] text-white py-3 rounded-xl font-medium transition-all duration-300 transform hover:scale-105 mt-auto shadow-lg">
                       Launch Tool
                    </button> */}
{/* <button className={`w-full py-3 rounded-xl font-medium transition-all duration-300 transform hover:scale-105 mt-auto shadow-lg ${
  isDark
    ...
    : 'bg-[#B6CEB4] hover:bg-[#A5BDA3] text-slate-800'
}`}>
  Launch Tool
</button>   */}
{/* 
<button className={`w-full py-3 rounded-xl font-medium transition-all duration-300 transform hover:scale-105 mt-auto shadow-lg ${
  isDark
    ? 'bg-slate-700 hover:bg-slate-600 text-white'
    : 'bg-[#91C4C3] hover:bg-[#7FB3B2] text-slate-800'
}`}>
  Launch Tool
</button>
...
<button className={`w-full py-3 rounded-xl font-medium transition-all duration-300 transform hover:scale-105 mt-auto shadow-lg ${
  isDark
    ? 'bg-slate-700 hover:bg-slate-600 text-white'
    : 'bg-[#80A1BA] hover:bg-[#6F90A9] text-white'
}`}>
  Launch Tool
</button>
...
<button className={`w-full py-3 rounded-xl font-medium transition-all duration-300 transform hover:scale-105 mt-auto shadow-lg ${
  isDark
    ? 'bg-slate-700 hover:bg-slate-600 text-white'
    : 'bg-[#708993] hover:bg-[#5F7882] text-white'
}`}>
  Launch Tool
</button>
<button className={`w-full py-3 rounded-xl font-medium transition-all duration-300 transform hover:scale-105 mt-auto shadow-lg ${
  isDark
    ? 'bg-slate-700 hover:bg-slate-600 text-white'
    : 'bg-[#A1C2BD] hover:bg-[#90B1AC] text-slate-800'
}`}>
  Launch Tool
</button>
